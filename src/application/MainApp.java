...
public class MainApp extends Application {
    ...
    public static void main(String[] args) {
        ...
        char[] array1 = new char[] { 'a', 'x', 'c', 'd' };
        char[] array2 = new char[] { 'z', 'y', 'i' };

        System.out.println("result 1= " + hasCommonChar(array1, array2));

        char[] array3 = new char[] { 'a', 'x', 'c', 'd' };
        char[] array4 = new char[] { 'z', 'y', 'i','x' };

        System.out.println("result 2= " + hasCommonChar(array3, array4));
        
        char[] array5 = new char[] { 'a', 'x', 'c', 'd' };
        char[] array6 = new char[] { 'a', 'y', 'i','e' };

        System.out.println("result 3= " + hasCommonChar(array5, array6));

      }

      public static boolean hasCommonChar(char[] array1, char[] array2) {

        Arrays.sort(array1);

        for (char a : array2) {
          boolean result = search(a, array1);
          if (result) {
            return result;
          }
        }
      ...
      public static boolean search(char item, char[] array) {
        int start = 0;
