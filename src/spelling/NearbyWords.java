...
public class NearbyWords implements SpellingSuggest {
	...
	public List<String> suggestions(String word, int numSuggestions) {
		...
		while(!queue.isEmpty() && retList.size() < numSuggestions) {
			String poppedStr = queue.remove(0);			
			List<String> distanceOneStrList = distanceOne(poppedStr, true);
			for (String distanceOneStr: distanceOneStrList) {
				if (!visited.contains(distanceOneStr)) {
					visited.add(distanceOneStr);
					retList.add(distanceOneStr);
				}
			}
		}
	...
	public static void main(String[] args) {
		  ...
		  // Dictionary implementation you prefer 
