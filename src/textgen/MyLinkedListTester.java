...
public class MyLinkedListTester {
	...
	public void testAddEnd() {
		...
		List<String> myList = new MyLinkedList<String>();
		myList.add("A");
		myList.add("B");
		myList.add("C");

		// test short list, first contents, then out of bounds
		assertEquals("Check first", "A", myList.get(0));
		assertEquals("Check second", "B", myList.get(1));
		assertEquals("Check second", "C", myList.get(2));
	...
	public void testAddAtIndex() {
		...
		myList.add(0, "D");
		// test short list, first contents, then out of bounds
		assertEquals("Check first", "D", myList.get(0));
	...
	public void testAddAtIndexEnd() {
		...
		myList.add("D");
		myList.add(3, "E");
		assertEquals("Check second", "E", myList.get(3));
